...
FWHM_age = 1e7    # Duration of SF event (Gaussian FWHM)
...
sfh_components = [[age_1, met_1, FWHM_age, sigma_met_1, mass_1], 
...
# Figure filename
fname_str = os.path.join(fig_path, "regularisation", f"young+old_pop_logfwhm={int(np.log10(FWHM_age))}")
